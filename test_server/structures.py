# Origin of source code is "urllib3/_collections.py"
...
class HTTPHeaderDict(MutableMapping[str, str]):
    ...
    def __eq__(self, other: object) -> bool:
        maybe_constructable = is_valid_headers_data(other)
    ...
    def extend(self, *args: ValidHTTPHeaderSource, **kwargs: str) -> None:
        ...
        if isinstance(other, HTTPHeaderDict):
            ...
            # In this branch, the object has a `keys` attr but is not a Mapping or any
            # of # the other types indicated in the method signature. We do some stuff
            # with # it as though it partially implements the Mapping interface, but
            # we're not doing that stuff safely AT ALL.
    ...
    def copy_from(self, other: "HTTPHeaderDict") -> None:
        for key in other:
